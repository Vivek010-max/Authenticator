...
function buttonClassName({ variant = "default", size = "default", className }) {
  const v = buttonVariants.variants.variant[variant] || buttonVariants.variants.variant.default;
  const s = buttonVariants.variants.size[size] || buttonVariants.variants.size.default;
  return cn(buttonVariants.base, v, s, className);
}
