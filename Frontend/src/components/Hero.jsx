...
export function Hero() {
  return (
    <div
      className="relative top-2 mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-100 selection:bg-black md:text-4xl lg:text-7xl dark:text-slate-100">
        ...
        <motion.p
          ...
          className="relative z-10 mx-auto max-w-xl py-4 text-center text-lg selection:bg-white font-normal text-neutral-200 dark:text-neutral-400">
